  ...
  return (
      <>
          <div className="flex flex-col space-y-2 bg-orange-grad  dark:bg-gamboge rounded-xl py-4 px-8 border border-black dark:text-black">
              ...
              <a
                  href={link}
                  className="space-x-1 py-2 text-lg bg-white w-full text-center border border-black rounded mx-auto p-3 align-center justify-center text-maroonx-11 dark:bg-black dark:text-white"
              >
                  Link
              </a>
          </div>
